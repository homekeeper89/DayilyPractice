...
EventManager는 클라이언트를 위해 인터페이스를 간소화 해주는 퍼사드다
EventManager는 컴포지션을 통해 hotelier과 Caterer등의 서브시스템 객체를 생성한다

최소 지식 원칙을 사용함 : 상호작용하는 객체를 아주 가까운 몇개의 객체로 최소화 한다
- 클래스간의 의존도가 높으면 시스템 유지보수가 어려움
